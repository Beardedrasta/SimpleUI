SimpleUI_Database = {
    Default = {
        ...
        SilenceWelcomeMessage = false,
        locked = true,
        HighlightDebuffBar = true,
        HighlightDebuffClass = false,
        ["Entities"] = {
            ["Modules"] = {
                disabled = {
                    Micromenu = nil,
            ...
            ["Unitframes"] = {
                ...
                locked = true,
                portraitalpha = 0.25,
                portraittexture = true,
                always2D = 1,
                hidepartyraid = 1,
                pastel = true,
                rangecheck = 1,
                manaColor = { r = 0, g = 0, b = 1, a = 1 },
                rageColor = { r = 1, g = 0, b = 0, a = 1 },
                energyColor = { r = 1, g = 0.96, b = 0.41, a = 1 },
                focusColor = { r = 1, g = 0.96, b = 0.41, a = 1 },
                abbrevname = true,
                abbrevnum = true,
                selfingroup = 0,
                stepsize = "Fast",
                castbar = {
                    anchorToFrame = 0,
                    texture = "StatusbarDefault",
                    fontSize = 12,
                    font = "SimpleUI",
                    castbarcolor = ".9, .2, .9, 1",
                ...
                player = {
                    ...
                    alpha = 0.2,
                    alpha_visible = 1,
                    alpha_outofrange = 0.5,
                    alpha_offline = 0.25,
                    portrait = "left",
                    portraitwidth = -1,
                    portraitheight = -1,
                    healthTexture = "StatusbarDefault",
                    manaTexture = "StatusbarDefault",
                    leaderIcon = true,
                    lootIcon = true,
                    happinessIcon = false,
                    raidIcon = true,
                    ...
                    pheight = 10,
                    ptxton = true,
                    txthealthcenter = "healthdyn",
                    txthealthleft = "unit",
                    txthealthright = "healthperc",
...
SimpleUI_AuraList = {
    ...
    debuffs = {
        ...
        ['Mocking Blow'] = { [0] = 6.0, },
        ['Molten Metal'] = { [0] = 15.0, },
        ['Moonfire'] = { [1] = 9.0, [2] = 18.0, [3] = 18.0, [4] = 18.0, [5] = 18.0, [6] = 18.0, [7] = 18.0, [8] = 18.0, [9] = 18.0, [10] = 18.0, [0] = 18.0 },
        ['Mortal Cleave'] = { [0] = 5.0, },
